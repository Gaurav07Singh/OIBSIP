package kunalwstDSA.tAndsComplexity;
...
public class ATM1 {
	...
	public static void main(String[] args)
	{
		...
		String accname = "  GAURAV SINGH ";
		String branchname = "DWARKA(west)";
		String branchaddress = "C-607, DWARKA ,DELHI";
		String branchIFSC = "SBIN2875962";
		
		int accnumber = 12239876;
		int password = 2001;
		int balance = 1000000;
		int minbal = 1000;
		boolean flag = true;
